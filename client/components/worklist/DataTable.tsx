            ...
            {headers.map((header) => (
              ...
              >
                <div className={`absolute z-0 ${header.width} bottom-0 inset-x-0`}>
                  <div className="flex min-h-px w-full bg-gray-400" />
                </div>
                <div className="text-gray-500 text-sm font-bold leading-[22px] z-0">
                  {header.label}
                </div>
              </th>
            ))}
          ...
          {data.map((row, index) => (
            ...
            >
              <td className="items-start relative flex gap-1 h-full w-[200px] p-1">
                <div className="items-center z-0 flex gap-1 text-sm text-foreground font-bold leading-loose my-auto">
                  <div className="gap-0.5 my-auto">
                    <div className="text-foreground text-sm leading-[22px]">
                      {row.patientName}
                    </div>
                  </div>
                </div>
                <div className="absolute z-0 w-[200px] bottom-0 inset-x-0">
                  <div className="flex min-h-px w-full bg-gray-300" />
                </div>
              </td>
              
              <td className="items-start relative flex gap-1 h-full w-[125px] p-1">
                <div className="items-center z-0 flex gap-1 text-sm text-foreground font-normal whitespace-nowrap leading-loose my-auto">
                  <div className="gap-0.5 my-auto">
                    <div className="text-foreground text-sm leading-[22px]">
                      {row.accountNumber}
                    </div>
              ...
              <td className="items-start relative flex gap-1 h-full w-[159px] p-1">
                <div className="items-center z-0 flex gap-1 text-sm text-foreground font-normal leading-loose my-auto">
                  <div className="gap-0.5 my-auto">
                    <div className="text-foreground text-sm leading-[22px]">
              ...
              <td className="relative flex gap-0.5 h-full w-[107px] p-1">
                <div className="items-center z-0 flex gap-1 text-foreground">
                  <div className="gap-0.5 my-auto">
                    <div className="text-foreground text-sm font-normal leading-[22px]">
                      {row.reqDate}
                    </div>
                    <div className="text-foreground text-right text-xs font-medium leading-[18px]">
                      {row.reqAge}
                    </div>
                  </div>
                </div>
              ...
              <td className="relative flex gap-0.5 h-full w-[137px] p-1">
                <div className="z-0 flex gap-1 text-foreground text-right">
                  <div className="gap-0.5">
                    <div className="text-foreground text-sm font-normal leading-[22px]">
                      {row.preReviewCharges}
                    </div>
                    <div className="text-foreground text-xs font-medium leading-[18px]">
              ...
              <td className="justify-center relative flex flex-col flex-1 shrink basis-[0%] gap-1 p-1">
                <div className="z-0 flex items-center gap-1 text-xs text-gray-600 font-medium whitespace-nowrap">
                  <div className="items-center rounded self-stretch flex min-h-6 gap-1 bg-gray-200 my-auto px-2 py-0">
                    <div className="text-gray-600 text-xs leading-[18px] self-stretch my-auto">
                      {row.status}
                    </div>
                  </div>
                </div>
              ...
              <td className="justify-center items-start relative flex gap-1 h-full w-[130px] p-1">
                <div className="z-0 flex items-center gap-1 text-xs text-primary font-bold whitespace-nowrap text-center my-auto">
                  <button
                    onClick={() => onViewClick?.(row.id)}
                    className="justify-center items-center border self-stretch flex gap-2 bg-[rgba(255,255,255,0.00)] my-auto px-3 py-[3px] rounded-[99px] border-solid border-primary hover:bg-blue-50 transition-colors"
                  >
