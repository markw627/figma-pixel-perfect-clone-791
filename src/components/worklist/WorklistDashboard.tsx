...
export const WorklistDashboard: React.FC = () => {
  ...
  const facilities = [
    ...
    { name: 'Hendersonville Medical Center', completion: '100% Complete', active: false, completionColor: 'text-[#467D20]' }
  ];
  ...
  return (
    <div className="justify-center items-stretch flex flex-col overflow-hidden w-[1400px] bg-[#F6F6F6]">
      ...
      <main className="flex w-full flex-col items-stretch px-6 py-4 max-md:max-w-full max-md:px-5">
        ...
        <section className="items-stretch shadow-[0_5px_8px_0_rgba(57,57,57,0.13)] flex w-full flex-col overflow-hidden bg-white mt-4 rounded-lg max-md:max-w-full">
          <header className="justify-center items-center flex w-full gap-2.5 text-2xl text-[#03173E] font-bold leading-none bg-[#E2E2E2] px-4 py-2 rounded-[8px_8px_0_0] border-b-[#E2E2E2] border-b border-solid max-md:max-w-full">
            <h2 className="text-[#03173E] text-2xl leading-8 self-stretch flex-1 shrink basis-[0%] my-auto max-md:max-w-full">
              ...
              <button
                ...
                className={`justify-center items-stretch self-stretch flex flex-col my-auto p-4 ${
                  activeFacility === facility.name 
                    ? 'border-b-2 border-b-[#0077B5] border-solid' 
                    : ''
                }`}
              >
                <div className={`flex min-h-6 items-center text-sm font-bold leading-loose justify-center ${
                  activeFacility === facility.name ? 'text-[#0077B5]' : 'text-[#6F6F6F]'
                }`}>
                ...
                <div className={`text-center text-xs font-medium leading-[18px] ${
                  facility.completionColor || 'text-[#6F6F6F]'
                }`}>
                  {facility.completion}
                </div>
              </button>
